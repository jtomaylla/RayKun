...
class DeleteProductDialog(val activity: Activity, taskIds: List<Int>, val callback: (allOccurrences: Boolean) -> Unit) {
    ...
    init {
        ...
        val view = activity.layoutInflater.inflate(R.layout.dialog_delete_product, null).apply {
