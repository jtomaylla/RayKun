...
import com.ecandle.raykun.receivers.CalDAVSyncReceiver
import com.ecandle.raykun.receivers.NotificationReceiver
import com.ecandle.raykun.services.SnoozeService
...
fun Context.launchNewTaskIntent() {
    ...
    Intent(applicationContext, TaskActivity::class.java).apply {
        putExtra(NEW_TASK_START_TS, getNewEventTimestampFromCode(code))
        addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
        startActivity(this)
    }
}

fun Context.launchNewItemIntent() {
