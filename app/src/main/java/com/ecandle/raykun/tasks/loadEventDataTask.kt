 ...
 */
class loadEventDataTask (internal var mycontext: Context) : android.os.AsyncTask<String, String, List<DataEvent>>() {
...
//            pdLoading.show()
    ...
    override fun doInBackground(vararg params: String): List<DataEvent>? {
        ...
        try {
            ...
            val data = java.util.ArrayList<DataEvent>()
            ...
            if (response_code == HttpURLConnection.HTTP_OK) {
                ...
                for (i in 0 until jArray.length()) {
                    ...
                    val eventData = DataEvent(
                    jsondata.getInt("id"),
                    jsondata.getString("name"),
                    jsondata.getString("description"),
                    jsondata.getString("priority"),
                    jsondata.getString("startdate"),
                    jsondata.getString("duedate"),
    ...
    override fun onPostExecute(result: List<DataEvent>?) {

        //after task done
        //pdLoading.dismiss()
        val mydata = result
        //mydata = data!!
        Log.d("loadEventDataTask",result.toString())
    }
