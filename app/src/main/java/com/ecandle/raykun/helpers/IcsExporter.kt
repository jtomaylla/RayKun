...
import com.ecandle.raykun.extensions.getFileOutputStream
import com.ecandle.raykun.extensions.writeLn
import com.ecandle.raykun.helpers.IcsExporter.ExportResult.*
...
class IcsExporter {
    ...
    fun exportEvents(activity: MyBaseSimpleActivity, file: File, events: ArrayList<Event>, callback: (result: ExportResult) -> Unit) {
