...
import com.ecandle.raykun.activities.DayActivity
import com.ecandle.raykun.extensions.config
import com.ecandle.raykun.extensions.launchNewEventIntent
import com.ecandle.raykun.services.WidgetService
...
class MyWidgetListProvider : AppWidgetProvider() {
    ...
    private fun performUpdate(context: Context) {
        ...
        appWidgetManager.getAppWidgetIds(getComponentName(context)).forEach {
            ...
            val startActivityIntent = Intent(context, CalendarActivity::class.java)
