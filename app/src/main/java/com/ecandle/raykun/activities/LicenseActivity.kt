...
import com.ecandle.raykun.extensions.underlineText
import com.ecandle.raykun.helpers.*
import com.ecandle.raykun.models.License
...
class LicenseActivity : MyBaseSimpleActivity() {
    ...
    private fun initLicenses() = arrayOf(
            ...
            //License(LICENSE_SIMPLE_CALENDAR, R.string.simplecalendar_title,R.string.simplecalendar_text, R.string.string.simplecalendar_url)
    )
}
