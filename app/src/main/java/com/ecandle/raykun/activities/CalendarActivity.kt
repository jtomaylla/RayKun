...
//import com.ecandle.raykun.R.id.calendar_fab
...
import com.ecandle.raykun.adapters.MyYearPagerAdapter
import com.ecandle.raykun.dialogs.EditRepeatingEventDialog
import com.ecandle.raykun.dialogs.FilterEventTypesDialog
import com.ecandle.raykun.dialogs.ImportEventsDialog
import com.ecandle.raykun.extensions.*
import com.ecandle.raykun.fragments.EventListFragment
import com.ecandle.raykun.fragments.WeekFragment
...
class CalendarActivity : SimpleActivity(), NavigationListener {
...
//    lateinit var mEventEndDateTime: DateTime
    ...
    fun loadUserEvents(){
        // Init Events Table
        dbHelper.initEventTable()

        //val savedSettings = SavedSettings(applicationContext)
        //val user_id:String? = savedSettings.getLoggedUserId()
        ...
        val loadEventData = loadEventDataTask(this)
    ...
    private fun saveEvent(event:DataEvent) {
        ...
        val mEventStartDateTime = DateTime(event.startdate)
        val mEventEndDateTime = DateTime(event.duedate)

        mEvent = Event()
        mEvent.id = 0
        //val newTitle = event_title.value
        val newTitle = event.name
        if (newTitle.isEmpty()) {
...
//        }
        ...
        mEvent.apply {
            ...
            flags = mEvent.flags or FLAG_ALL_DAY
